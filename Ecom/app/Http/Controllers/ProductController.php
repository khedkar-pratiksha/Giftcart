...
class ProductController extends Controller
{
    ...
    public function viewOrder(){
        ...
        ->select('orders.id as oid','orders.coupon_used as used','orders.payment_mode as pmode','orders.payment_status as pstatus','orders.transaction_id as trans_id','orders.amount as amount','user_addresses.*','orders.status as status')->get();
        foreach($orders as $o){
