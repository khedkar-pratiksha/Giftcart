...
@section('content')
    ...
    <div class="card ">
        <div class="card-body">
        <form action="{{url('admin/category/postupdate/').'/'.$cat->id}}" method="post">
            @csrf
            ...
            <div class="form-group ">
                <label for="category_slug" class=" col-form-label">Category Description<span class="text-danger">*</span></label>
                    <textarea class="form-control" id="category_slug" name="category_slug" >
                {{$cat->category_slug}}
</textarea>
                    @error('category_slug')
                    <div class="text-danger">
