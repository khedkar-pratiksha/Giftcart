              ...
              <div class="card-body">
                <table id="users" class="table table-bordered table-hover w-100">
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="{{url('admin/category/update').'/'.$cat->id}}" class="btn btn-primary"><i class="fa fa-edit"></i></a>
                        <a href="{{url('admin/category/delete').'/'.$cat->id}}" onclick="return deleteConfirm();" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                      </td>
                    </tr>
                    <?php $count++?>
                    @endforeach
