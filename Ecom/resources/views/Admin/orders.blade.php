                ...
                <table id="users" class="table table-bordered table-hover w-100">
                    ...
                    <tr>
                      ...
                      <td> 
                          ...
                          <div class="row">
                            <div class="col-5">
                           <img src="{{asset('/images/products/').'/'.$orderP->image}}" width="70" height="70">
                              </div>
                              <div class="col-7 pl-3"> 
                           {{$orderP->product_name}}<br>
                            Rs.{{$orderP->price}}<br>
                          </div>
                          </div>  
                          @endforeach
                      ...
                      <td>{{$order[2]}}</td>
                      <td>{{$order[0]->pmode?"Online":"Cash on delivery"}}</td>
                      <td>{{$order[0]->pstatus?"Completed":"Pending"}}</td>
                      <td>{{$order[0]->trans_id==NULL?"N.A":$order[0]->trans_id}}</td>
                      <td>
