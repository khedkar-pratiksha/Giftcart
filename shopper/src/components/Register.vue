          ...
          <div>
            ...
            <form @submit.prevent="handleSubmit">
              <div class="form-group">
                ...
                <input type="text" v-model="user.firstName" id="firstName" name="firstName" class="form-control" :class="{
              ...
              <div class="form-group">
                ...
                <input type="text" v-model="user.lastName" id="lastName" name="lastName" class="form-control" :class="{
              ...
              <div class="form-group">
                ...
                <input type="password" v-model="user.password" id="password" name="password" class="form-control" :class="{
